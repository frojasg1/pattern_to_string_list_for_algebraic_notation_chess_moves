...
The new function I am currently programming, is to create a library which will able to work with scanned Pdfs, offering a similar functionality than when using pdfbox library for regular Pdfs
